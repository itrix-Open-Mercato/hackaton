...
### Phase 1 — Core (current branch: `feature/sync-apilio-integration`)
Complete:
...
### 2026-04-10
- Initial specification written to document the Phase 1 implementation on branch `feature/sync-apilio-integration`.
