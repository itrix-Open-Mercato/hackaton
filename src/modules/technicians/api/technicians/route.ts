  ...
  list: {
    ...
    transformItem: (item: BaseFields): TechnicianListItem => {
      ...
      return {
        ...
        displayName: nullable('displayName', 'display_name'),
        firstName: nullable('firstName', 'first_name'),
        lastName: nullable('lastName', 'last_name'),
        email: nullable('email', 'email'),
        phone: nullable('phone', 'phone'),
        locationStatus: (source.locationStatus ?? source.location_status ?? 'in_office') as string,
        languages: (source.languages ?? []) as string[],
        vehicleId: nullable('vehicleId', 'vehicle_id'),
        vehicleLabel: nullable('vehicleLabel', 'vehicle_label'),
        currentOrderId: nullable('currentOrderId', 'current_order_id'),
