# Capability: Technician Profiles

## Purpose

Data model, API, and permissions for managing technician profiles — the core entities linking staff members to skills, certifications, and service capabilities.
